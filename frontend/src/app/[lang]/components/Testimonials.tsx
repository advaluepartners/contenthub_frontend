    ...
    <div className="flex flex-col items-center mx-12 lg:mx-0">
      ...
      <div className="relative text-center">
        <svg
          ...
          viewBox="0 0 512 512"
          fill="currentColor"
          className="absolute top-0 left-0 w-8 h-8 dark:text-gray-900"
        >
      ...
      <span className="w-12 h-1 my-2 rounded-lg bg-white"></span>
      <p>{authorName}</p>
    </div>
  );
}
...
export default function Testimonials({ data }: TestimonialsProps) {
  return (
    <section className="dark:bg-white dark:text-gray-900  m:py-12 lg:py-24">
